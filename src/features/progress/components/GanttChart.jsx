  ...
  return (
    <div style={{ background: '#fff', padding: 24, borderRadius: 8 }}>
      ...
      <div style={{ display: 'flex', borderBottom: '1px solid #f0f0f0', paddingBottom: 10, marginBottom: 10 }}>
        ...
        <div ref={scrollContainerRef} className="scrollbar-hide" style={{ flex: 1, minWidth: 0, overflowX: 'auto', overflowY: 'hidden' }}>
          <div style={{ ...gridStyle }}>
            {config.renderHeader()}
          </div>
        </div>
                ...
                {cat.projects.map(proj => {
                  ...
                  return (
                    <div key={proj.id} style={{ display: 'flex', height: 45, borderBottom: '1px dashed #f5f5f5', alignItems: 'center' }}>
                      ...
                      <div style={{ flex: 1, minWidth: 0, overflowX: 'auto', overflowY: 'hidden', height: '100%' }} className="scrollbar-hide">
